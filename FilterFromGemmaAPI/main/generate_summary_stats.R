...
affymetrix_GSEs <- read_delim(paste0(results_dir,"/","filter_by_technology/","affymetrix_GSEids"), delim = "\n", col_names = FALSE)
ion_torrent_GSEs <- read_delim(paste0(results_dir,"/","filter_by_technology/","ion_torrent_experiments"), delim = "\n", col_names = FALSE)
nano_string_GSEs <- read_delim(paste0(results_dir,"/","filter_by_technology/","nano_string_experiments"), delim = "\n", col_names = FALSE)
lnc_rna_GSEs <- read_delim(paste0(results_dir,"/","filter_by_technology/","lnc_rna_experiments"), delim = "\n", col_names = FALSE)
ab_GSEs <- read_delim(paste0(results_dir,"/","filter_by_technology/","ab_experiments"), delim = "\n", col_names = FALSE)
